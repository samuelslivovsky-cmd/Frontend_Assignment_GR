    ...
    <label className="flex cursor-pointer items-center gap-3 text-sm text-gray-900">
      <span className="relative inline-flex size-4 shrink-0">
        <input
          ...
          {...props}
        />
        <span className="pointer-events-none flex size-4 items-center justify-center rounded border border-gray-300 bg-white transition-colors peer-checked:border-indigo-600 peer-checked:bg-indigo-100 peer-focus-visible:outline-2 peer-focus-visible:outline-offset-2 peer-focus-visible:outline-indigo-600 peer-checked:[&>svg]:opacity-100">
