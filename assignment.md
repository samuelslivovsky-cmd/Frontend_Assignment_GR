...
- [x] Voľba formy pomoci — všeobecný príspevok nadácii alebo konkrétnemu útulku
- [x] Výber útulku zo zoznamu, povinný len pri príspevku konkrétnemu útulku
- [x] Výška príspevku vrátane vlastnej hodnoty
- [x] Meno — 2–20 znakov (v zadaní nepovinné, API však prázdne `firstName` odmieta, viď README)
...
- [x] Next.js
- [x] TypeScript
- [x] TanStack Query na server state
- [x] Client state management — zustand
- [x] Knižnica pre správu formulára — react-hook-form
- [x] Premyslená štruktúra projektu
