...
export function FlagSK(props: FlagProps) {
  return (
    <svg {...BASE} fill="none" {...props}>
      ...
      />
      <path
        d="M10 20a10.002 10.002 0 0 0 9.378-6.522H.622A10.002 10.002 0 0 0 10 20Z"
        fill="#D80027"
      />
      <path
        d="M2.585 5.652v4.988c0 2.838 3.708 3.707 3.708 3.707S10 13.478 10 10.64V5.652H2.585Z"
        fill="#F0F0F0"
      />
      <path
