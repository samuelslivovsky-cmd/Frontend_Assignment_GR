...
export default function DonationLayout({ children }: { children: ReactNode }) {
  return (
    <div className="mx-auto flex w-full max-w-[1440px] gap-10 p-4 sm:p-6 lg:p-10">
      ...
      <div className="flex min-h-[calc(100dvh-2rem)] flex-1 justify-center sm:min-h-[calc(100dvh-3rem)] lg:min-h-[calc(100dvh-5rem)]">
        <div className="flex w-full max-w-[600px] flex-col gap-8 sm:gap-10">
          <Stepper />
